              ...
              <div className="bg-white p-2 border-t border-gray-200">
                ...
                <form onSubmit={handleSendMessage} className="flex">
                  <button
                    ...
                    className="bg-gray-100 text-gray-600 px-3 py-1.5 border border-gray-200 rounded-l-lg hover:bg-gray-200 focus:outline-none"
                  ...
                  <input
                    ...
                    className="flex-1 px-3 py-1.5 border-t border-b border-r border-gray-200 focus:outline-none focus:ring-1 focus:ring-green-500"
